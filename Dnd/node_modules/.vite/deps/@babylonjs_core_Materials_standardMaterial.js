      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-YJZ656J6.js"), import("./default.fragment-7XC2BWWS.js")]);
          } else {
            await Promise.all([import("./default.vertex-HVXVMMRN.js"), import("./default.fragment-D2C3SV4I.js")]);
          }
